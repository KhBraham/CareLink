...
@Component({
  ...
  template: `
    <div class="bg-[#1e2756] text-white py-12">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#" class="text-gray-300 hover:text-white">Departments</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li class="flex items-center space-x-2">
                ...
                <span>contact&#64;carelink.com</span>
              </li>
            </ul>
          </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-700 text-center text-gray-300">
          <p>&copy; 2025 CARELINK. All rights reserved.</p>
        </div>
      </div>
    </div>
  `,
